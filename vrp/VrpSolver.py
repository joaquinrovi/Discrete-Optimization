...
class VrpSolver(object):
    ...
    def solve(self,
              ...
              exchange=True,
              ladder=True,
              max_iterations=None,  # Add a maximum iteration parameter
              t_threshold=None,
              verbose=False,
              debug=False):
        improved = True
        ...
        while improved and (max_iterations is None or iterations < max_iterations):  # Check maximum iteration limit
            ...
            prev_obj = self.obj
            if verbose or debug:
                print(f"Iteration {iterations}: {self.obj}")
